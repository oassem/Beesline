...
id:any;
  add(){
    console.log('hello');
    // function to receive if any order status is changed :)
    this.data=this.dashboardService.getChangedStatus();
    console.log(this.data);
    if(this.data !=undefined){
      console.log(this.data);
    // length=this.ELEMENT_DATA.length;
   this.Status= this.data['orderStatus'];
   this.id=this.data['id'];
    // console.log(length);
    this.ELEMENT_DATA[this.id]['orderStatus']=this.Status;
    // this.ELEMENT_DATA.push(this.data);
    console.log(this.ELEMENT_DATA);
    console.log(this.ELEMENT_DATA[this.id]['orderStatus']);
  }
  }
  showOrder(element:{}){
    console.log(element);

    this.router.navigate(['/orders/orderDetails/',element]);
 
 }
 changeStatus(element:any){
   console.log(element);
   this.router.navigate(['/orders/changeStatus/',element]);
 }
